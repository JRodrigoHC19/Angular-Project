...
const URL_MESSAGES = "http://64.176.2.120:8080/messages/"
const URL_USER_LIST = "http://64.176.2.120:8080/users/";
const URL_POST_CHANNEL ="http://64.176.2.120:8080/channels/";
...
export class DatabaseService {
  ...
  getChat_One(id: number): Observable<Message[]> {
    const URL_MSG_BY_ID = `http://64.176.2.120:8080/messages/${id}`;
  ...
  getUser_One(id: number): Observable<User[]> {
    const URL_ONE_USER = `http://64.176.2.120:8080/users/search/${id}`;
  ...
  getQRCode_One(id: number): Observable<User_Channel[]> {
    const URL_GET_CHANNEL = `http://64.176.2.120:8080/channels/search/${id}`;
